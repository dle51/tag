...
from tag.gym.envs.walk.walk import GymWrapper, SBWrapper, Walk, WalkEnvConfig
...
def main(cfg: Config):
    ...
    env = SBWrapper(gym_env, success_threshold=1.0)
    model = PPO(
        "MlpPolicy",
        env,
        learning_rate=3e-4,
    ...
    callback = CheckpointCallback(save_freq=10_000, save_path="./models/", name_prefix="ppo_genesis")
